...
/*GetClusterSupportedPlatforms swagger:route GET /clusters/{cluster_id}/supported-platforms installer getClusterSupportedPlatforms

Get all cluster supported platforms
