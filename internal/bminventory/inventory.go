...
func (b *bareMetalInventory) updatePlatformSources(params installer.UpdateClusterParams, updates map[string]interface{}, usages map[string]models.Usage) {
	...
	if params.ClusterUpdateParams.Platform != nil && params.ClusterUpdateParams.Platform.Type != models.PlatformTypeBaremetal {
		withCredentials := params.ClusterUpdateParams.Platform.Type == models.PlatformTypeVsphere && params.ClusterUpdateParams.Platform.Vsphere != nil && params.ClusterUpdateParams.Platform.Vsphere.VCenter != nil
		b.setUsage(true, usage.PlatformSelectionUsage, &map[string]interface{}{
